      ...
      <ul class="layui-nav layui-nav-tree layui-bg-blue"  lay-filter="test">
        ...
        <li class="layui-nav-item layui-nav-itemed">
          ...
          <dl class="layui-nav-child ">
            ...
            <dd class=" layui-this"><a href="ssrf.php">SSRF</a></dd>
...
<!-- -侧边导航栏结束  --> 
  ...
  <div class="layui-body">
    ...
    <h2 class="div-colla-title"><i class="layui-icon">&#xe65b;</i>服务端请求伪造（SSRF）</h2>
    </div>
      <div class="layui-progress">
        <div class="layui-progress-bar layui-bg-blue" lay-percent="100%"></div>
      </div>
  <div class="layui-colla-item">
    <h2 class="layui-colla-title">SSRF-1</h2>
    ...
    <table class="layui-table">
      ...
      <tbody>
        <tr>
          ...
          <td>有回显的SSRF</td>
          <td>
        <a href="vul/ssrf/ssrf1/index.php" class="layui-btn" target="_blank">打开靶场</a>
    </td>
        </tr>
      </tbody>
    </table>
  ...
  <div class="layui-colla-item">
    <h2 class="layui-colla-title">SSRF-2</h2>
    <div class="layui-colla-content">
    <table class="layui-table">
      <colgroup>
        <col width="5%">
      ...
      <tbody>
        <tr>
          ...
          <td>半回显的SSRF</td>
          <td>
        <a href="vul/ssrf/ssrf2/index.php" class="layui-btn" target="_blank">打开靶场</a>
    </td>
        </tr>
      </tbody>
    </table>
  ...
  <div class="layui-colla-item">
    <h2 class="layui-colla-title">SSRF-3</h2>
    <div class="layui-colla-content">
    <table class="layui-table">
      <colgroup>
        <col width="5%">
      ...
      <tbody>
        <tr>
          ...
          <td>无回显的SSRF</td>
          <td>
        <a href="vul/ssrf/ssrf3/index.php" class="layui-btn" target="_blank">打开靶场</a>
    </td>
        </tr>
      </tbody>
    </table>
  ...
  <div class="layui-colla-item">
    <h2 class="layui-colla-title">SSRF-4</h2>
    <div class="layui-colla-content">
    <table class="layui-table">
      <colgroup>
        <col width="5%">
      ...
      <tbody>
        <tr>
          ...
          <td>有过滤的SSRF</td>
          <td>
        <a href="vul/ssrf/ssrf4/index.php" class="layui-btn" target="_blank">打开靶场</a>
    </td>
        </tr>
      </tbody>
    </table>
