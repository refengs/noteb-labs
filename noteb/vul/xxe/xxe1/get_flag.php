...
<head>
	...
	<style type="text/css">
body {background-image: url(../../../src/images/bg.png);
}
</style>
...
if (empty($_POST["flag"])) {
	...
	$flag = ($_POST['flag']);
	if ($flag =="flag{xxe-daguai111}") {
		echo "<script>ok() </script><a href='javascript:history.go(-1)'><font color='red'>返回上一步</a>";
	}else{
		echo "<script>error();</script><a href='javascript:history.go(-1)'><font color='red'>返回上一步</a>	";
	}
}
