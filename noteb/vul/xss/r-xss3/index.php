...
{     
confirm("flag{get_xss3_is_very_easy!!!}");
}
</script>
    <body>
        <div class="div_title">
        ...
        <div class="div_search">
            <input id="wd" name="search" form="search" type="text" class="input_search" placeholder="请输入你的内容" value='<?php echo htmlspecialchars($s);?>' />
