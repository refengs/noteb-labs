...
{     
confirm("flag{get_xss_js_is_easy!!!}");
}
var $a="a";
$a;
</script>
    <body>
        ...
        <div class="div_search">
            <input id="wd" name="search" form="search" type="text" class="input_search" placeholder="请输入你的内容" value='' /><script>var $a ="<?php echo $s; ?>"; </script>
