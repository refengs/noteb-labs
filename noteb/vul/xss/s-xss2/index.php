...
{     
confirm("flag{get_sxss2-soe44444!!!}");
}
...
//使用预编译，防止注入
    $sql = "INSERT INTO `s-xss2`(`text`) values (?) ";
...
<?php 
    $sql = "SELECT * FROM `s-xss2` order by id DESC ";
            ...
            echo "<div class='comment-wrap'>
                     ...
                     comment-odd comment-by-author'>
                            ...
                            <div class='comment-body flex flex-direction-column'>
                                ...
                                <div class='comment-content'><p><input type='text' value='$text'></p></div>
                            </div>
                        </div>
                    </div>";
        }else{
