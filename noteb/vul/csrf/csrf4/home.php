...
if (empty($_SESSION["NotebUser"])) {
 ...
 ?>
<?php 
if (empty($_SESSION["test_username"])||empty($_SESSION["token"])) {
    exit();
}
...
if (!empty($_POST['token'])) {
    if ($_POST['token'] == $_SESSION["token"] ) {
        ...
        echo "<script>alert('你以为密码是芝麻开门？？');</script>";
    }
}
	...
	<div id="output">
		<div class="containerT">
			...
			<form class="form" id="entry_form" method="post" action="">
                ...
                <input type="hidden" name="token" placeholder="确认密码" id="entry_password" value="<?php echo $_COOKIE["token"]; ?>">
