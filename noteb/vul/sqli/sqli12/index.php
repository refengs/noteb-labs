...
<div class="container">
    <section id="passReset" class=" center-block">
        <h2 class="passReset-title text-center">POST注入3:嵌套子查询注入（双查询注入）</h2>
        ...
        if (empty($_POST['username']) || empty($_POST['password'])) {
            ...
            $fw = new writeFW;
            $fw->fw($wt,"sqli12.txt");
            $sql = "select username,password from sqli_12 where username=('$username') and password=('$password') limit 0,1";
