...
<div class="container">
    <section id="passReset" class=" center-block">
        <h2 class="passReset-title text-center">万能密码登陆</h2>
        ...
        if (empty($_POST['username']) || empty($_POST['password'])) {
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9 col-xs-9">
            <input type="password" name="password" class="form-control" id="password" placeholder="填写你的密码">
            </div>
                </div>
            ...
            $fw = new writeFW;
            $fw->fw($wt,"sqli10.5.txt");
            $sql = "select username,password from sqli_10_1 where username=('$username') and password=('$password') limit 0,1";
            ...
            if ($result) {
                ...
                if ($row) {
                    ...
                    echo "<br>";
                    echo "<script>alert('你的flag是：flag{wannengmima}')</script>";
                }else{
                    echo "<b>登陆失败！</b><br>";
                }
            }else{
