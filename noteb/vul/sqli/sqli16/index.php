...
<div class="container">
    <section id="passReset" class=" center-block">
        <h2 class="passReset-title text-center">POST注入7:有点安全的过滤</h2>
        ...
        if (empty($_POST['username']) || empty($_POST['password'])) {
            ...
            $fw = new writeFW;
            $fw->fw($wt,"sqli16.txt");
            $sql = "select username,password from sqli_16 where username=('$username') and password=('$password') limit 0,1";
