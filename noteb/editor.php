      ...
      <ul class="layui-nav layui-nav-tree layui-bg-blue"  lay-filter="test">
        ...
        <li class="layui-nav-item layui-nav-itemed">
          ...
          <dl class="layui-nav-child ">
            ...
            <dd class=" layui-this"><a href="editor.php">富文本编辑器</a></dd>
...
<!-- -侧边导航栏结束  --> 
  ...
  <div class="layui-body">
    ...
    <h2 class="div-colla-title"><i class="layui-icon">&#xe65b;</i>富文本编辑器漏洞</h2>
    </div>
      <div class="layui-progress">
        <div class="layui-progress-bar layui-bg-blue" lay-percent="100%"></div>
      </div>
  <div class="layui-colla-item">
    <h2 class="layui-colla-title">富文本编辑器漏洞-1</h2>
    ...
    <table class="layui-table">
      ...
      <tbody>
        <tr>
          <td>1</td>
          <td>富文本编辑器漏洞-1</td>
          <td>存在漏洞的简单的富文本编辑器</td>
          <td><a href="vul/editor/index.php" class="layui-btn" target="_blank">打开靶场</a>
  </form> </td>
        </tr>
      </tbody>
    </table>
  ...
  <div class="layui-colla-item">
    <h2 class="layui-colla-title">Fckeditor编辑器</h2>
    <div class="layui-colla-content">
    <table class="layui-table">
      <colgroup>
        <col width="5%">
      ...
      <tbody>
        <tr>
          <td>1</td>
          <td>Fckeditor编辑器</td>
          <td>Fckeditor编辑器-php</td>
          <td><a href="vul/editor/fckedior/index.php" class="layui-btn layui-btn-disabled" target="_blank">打开靶场</a>
  </form> </td>
        </tr>
      </tbody>
    </table>
