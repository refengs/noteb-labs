...
<!--   <div class="layui-colla-item">
    <h2 class="layui-colla-title">脏牛提权</h2>
    ...
    <table class="layui-table">
      ...
      <tbody>
        <tr>
          <td>1</td>
          <td>脏牛提权</td>
          <td>linux潜藏已久的漏洞，能覆盖root的密码。。当然。。。前提是你得拿到一个用户。<br> 通过啥方式，你自己想？SSH爆破？</td>
          <td><form class="layui-form" action="vul/root/dirty/flag.php" method="POST">
        <input type="text" name="flag" required lay-verify="required" placeholder="请输flag" autocomplete="off" class="layui-input"><a href="想去吧 少侠 flag在root主目录哦" class="layui-btn" target="_blank">打开靶场</a>
